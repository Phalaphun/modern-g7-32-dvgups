...
#let gost(
  ...
  outline-depth: default-outline-depth,
  ...
  image-after-text-gap: default-image-after-text-gap,
  image-caption-gap: default-image-caption-gap,
  image-before-text-gap: default-image-before-text-gap,
  image-after-image-gap: default-image-after-image-gap,
  image-before-heading-level-2-gap:
    default-image-before-heading-level-2-gap,
  ...
  long-listing-line-inset: default-long-listing-line-inset,
  long-listing-first-line-inset: default-long-listing-first-line-inset,
  long-listing-line-leading: default-long-listing-line-leading,
  long-listing-line-min-height: default-long-listing-line-min-height,
  ...
  table-cell-inset: default-table-cell-inset,
  table-cell-leading: default-table-cell-leading,
  table-cell-min-height: default-table-cell-min-height,

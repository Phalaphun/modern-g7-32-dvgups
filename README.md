...
|---|---:|---|
| `default-table-and-raw-figure-margin-above` | `24pt` | Базовый внешний отступ перед таблицами и листингами. Для таблицы после текста или другой таблицы переопределяется контекстными параметрами. |
| `default-table-and-raw-figure-below-lines` | `2` | Базовое число строк основного шрифта после таблицы или листинга. Для таблицы перед текстом или заголовком второго уровня переопределяется контекстными параметрами. |
